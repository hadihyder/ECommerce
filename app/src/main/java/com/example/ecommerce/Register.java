...
public class Register extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password = (EditText)findViewById(R.id.editTextPassword_Register);
        mRegisterbtn = (Button)findViewById(R.id.buttonRegister);
        mLoginPageBack = (TextView)findViewById(R.id.backtoLogin);
...
//        EditText mobileno=(EditText)findViewById(R.id.editTextMobileNo);
//        EditText email=(EditText)findViewById(R.id.editTextEmail);
//        EditText password =(EditText)findViewById(R.id.editTextPassword_Register);
//
//
//    }
//}
